...
RandomForest_model = RandomForestRegressor(n_estimators=20, max_depth=20) # 20 trees, each with a depth of 20. The best result so far.
RandomForest_model.fit(X_train, y_train.ravel())
accuracy_RandomForest = RandomForest_model.score(X_test, y_test)
print("Accuracy of Random Forest Model: ", accuracy_RandomForest)